        ...
        <>
          ...
          <section className="discover-books">
            ...
            <div className="discover-image">
              <img src={screenshot} alt="Shelfie catalog view" />
            </div>
          </section>

          <section className="mobile-books">
            <div className="mobile-image">
              <img src={mobileScreenshot} alt="Shelfie on mobile" />
            </div>
            <div className="mobile-description">
              <h3>Mobile friendly</h3>
              <p>
                Shelfie's <strong>clean</strong> and <strong>responsive</strong> design
                ensures a smooth and enjoyable experience on any mobile device.
              </p>
              <p>Your next great read is always just a tap away.</p>
            </div>
          </section>
          ...
          >
            ...
            <div className="feature-card">
              <div className="card-icon-wrapper">
                <FontAwesomeIcon icon={faWandMagicSparkles} size="2x" color="white" />
              </div>
            ...
            <div className="feature-card">
              <div className="card-icon-wrapper">
                <FontAwesomeIcon icon={faBookOpenReader} size="2x" color="white" />
              </div>
            ...
            <div className="testimonials-grid-container">
              <div className="testimonial-item">
                ...
                <div className="testimonial-author">
                  <img src="/images/profile-picture2.webp" alt="John Doe" />
                  <h5>John Doe</h5>
                </div>
              </div>
              ...
              <div className="testimonial-item">
                ...
                <div className="testimonial-author">
                  <img src="/images/profile-picture4.webp" alt="Jane Smith" />
                  <h5>Jane Smith</h5>
                </div>
              </div>
              ...
              <div className="testimonial-item">
                ...
                <div className="testimonial-author">
                  <img src="/images/profile-picture.webp" alt="Alex Johnson" />
                  <h5>Alex Johnson</h5>
                </div>
              </div>
            </div>
